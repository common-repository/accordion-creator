  ...
  class SkeletFramework_Shortcode_Manager extends SkeletFramework_Abstract{
    ...
    public function __construct( $options ) {
      ...
      if( ! empty( $this->options ) ) {
        ...
        $this->addAction( 'admin_footer', 'shortcode_dialog2', 99 );
        $this->addAction( 'customize_controls_print_footer_scripts', 'shortcode_dialog2', 99 );
    ...
    public function media_shortcode_button( $editor_id ) {
      ...
      if( ! in_array( $post_type, $this->exclude_post_types ) ) {
        echo '<a href="#" class="button button-primary sk-shortcode" data-editor-id="'. $editor_id .'">'. __( 'Add Accordion Shortcode', SK_TEXTDOMAIN ) .'</a>';
      }
    ...
    ?>
      <div id="sk-shortcode-dialog" class="sk-dialog" title="<?php _e( 'Add Accordion Shortcode', SK_TEXTDOMAIN ); ?>">
